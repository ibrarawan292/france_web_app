...
const MainDashboard = () => {
  return (
    <div className="w-full flex p-10 ">
      {/* LEFT HAND SIDE  */}
      <div className="w-[65%] p-5 space-y-5 flex flex-col justify-center items-center">
        {/* INNER CONTAINER FOR QUERIES */}
        <div className="w-11/12 h- h-[40vh]  px-5 py-5 bg-white rounded-xl shadow-lg">
          {/* SEARCH BAR  */}
        ...
        <div className="w-11/12 flex justify-between">
          ...
          <div className="w-[47%] h-[40vh] px-5 py-5 bg-white rounded-xl shadow-lg">
            {/* SEARCH BAR  */}
            <span className="w-full flex">
              <input
                type="search"
      ...
      <div className="w-[35%] p-5">
        <div className="w-[25%] px-3 bg-cyan-600 rounded-xl fixed right-14 divide-y-2 divide-slate-100">
